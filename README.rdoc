...
This is a test that benchmarks the performance of <tt>has_many</tt> associations in Rails 3 vs Rails 4. It's meant to be used in conjunction with https://github.com/pawelgut/rails-4-association-performance
